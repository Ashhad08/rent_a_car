...
final class AvailableForRentVehiclesLoading
    extends AvailableForRentVehiclesState {
  @override
  List<Object> get props => [];
}

final class AvailableForRentVehiclesLoaded
    extends AvailableForRentVehiclesState {
  final List<VehicleModel> _vehicles;

  List<VehicleModel> get vehicles => _vehicles;

  const AvailableForRentVehiclesLoaded({required List<VehicleModel> vehicles})
      : _vehicles = vehicles;
...
final class AvailableForRentVehiclesError
    extends AvailableForRentVehiclesState {
  final String _error;
