                                      ...
                                      final res =
                                        ...
                                        engineCapacity:
                                            _engineCapacityController.text
                                                .trim(),
                                        chasisNo: _chassisNumberController.text
                                            .trim(),
                                        engineNo:
                                            _engineNumberController.text.trim(),
                                        rateWithDriver:
                                            _rateWithDriverController.text
                                                .trim(),
                                        rateWithoutDriver:
                                            _rateWithoutDriverController.text
                                                .trim(),
                                        discountWeek: _weeklyDiscountController
                                            .text
                                            .trim(),
                                        discountMonth:
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: getIt<AppColors>().kPrimaryColor),
                ),
                alignment: Alignment.center,
